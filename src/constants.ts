...
export const SITE_DATA = {
    ...
    x: "",             // X logo → x.com
    imdb: "https://www.imdb.com/name/nm13108906/", // REPLACED BLUESKY WITH IMDB
    linkedin: "https://www.linkedin.com/in/brendoncabral/",
    github: "",
    scholar: "",
    email: "https://letterbird.co/brendoncabral",

    // One-line research tagline used for SEO and social sharing meta tags
    description: "Precision Logistics & Operations | Production Leader",
